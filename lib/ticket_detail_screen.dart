...
import 'alert_screen.dart'; // Importante: Importamos la pantalla de alerta

class TicketDetailScreen extends StatelessWidget {
  // Recibimos los datos del ticket para mostrarlos
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  const Icon(Icons.notifications_none, color: Color(0xFF1976D2), size: 28),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                // AQUÍ ESTÁ LA NAVEGACIÓN CONECTADA
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
